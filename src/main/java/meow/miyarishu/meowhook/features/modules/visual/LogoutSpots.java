...
public class LogoutSpots
    ...
    public LogoutSpots() {
        super("LogoutSpots", "Renders LogoutSpots", Module.Category.VISUAL, true, false, false);
    }
    ...
    public void onConnection(ConnectionEvent event) {
        if (event.getStage() == 0) {
            ...
            if (entity != null && this.message.getValue().booleanValue()) {
                Command.sendMessage("\u00a7a" + entity.getName() + " is back at" + (this.coords.getValue() != false ? " at (" + (int) entity.posX + ", " + (int) entity.posY + ", " + (int) entity.posZ + ")!" : "!"));
            }
    ...
    private void renderNameTag(String name, double x, double yi, double z, float delta, double xPos, double yPos, double zPos) {
        ...
        String displayTag = name + " x" + (int) xPos + ", y" + (int) yPos + ", z" + (int) zPos;
