...
import meow.miyarishu.meowhook.util.NordTessellator;
import meow.miyarishu.meowhook.util.TotemPopCham;
...
public class PopChams extends Module {
    ...
    public PopChams() {
        super("PopChams", "Renders when some1 pops", Category.VISUAL, true, false, false);
        register(self);
        register(rL);
        register(gL);
        register(bL);
