...
public class GlintModify extends Module {
    ...
    public static Color getColor(long offset, float fade) {
        if (!MeowHook.moduleManager.getModuleByClass(GlintModify.class).rainbow.getValue()) {
            return new Color(MeowHook.moduleManager.getModuleByClass(GlintModify.class).red.getValue(), MeowHook.moduleManager.getModuleByClass(GlintModify.class).green.getValue(), MeowHook.moduleManager.getModuleByClass(GlintModify.class).blue.getValue());
        }
