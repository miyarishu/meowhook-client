...
import meow.miyarishu.meowhook.event.events.KeyPressedEvent;
...
public class NoSlowDown extends Module {
    ...
    public void onUpdate() {
        if (guiMove.getValue().booleanValue()) {
            if (NoSlowDown.mc.currentScreen instanceof GuiOptions || NoSlowDown.mc.currentScreen instanceof GuiVideoSettings || NoSlowDown.mc.currentScreen instanceof GuiScreenOptionsSounds || NoSlowDown.mc.currentScreen instanceof GuiContainer || NoSlowDown.mc.currentScreen instanceof GuiIngameMenu || NoSlowDown.mc.currentScreen instanceof MeowHookGui) {
