...
extends Module {
    ...
    public void onUpdate() {
        ...
        for (EntityPlayer player : ToolTips.mc.world.playerEntities) {
            if (player == null || player.getHeldItemMainhand() == null || !(player.getHeldItemMainhand().getItem() instanceof ItemShulkerBox) || !this.own.getValue().booleanValue() && ToolTips.mc.player.equals((Object)player)) continue;
