...
import meow.miyarishu.meowhook.event.events.RenderEntityModelEvent;
...
public class CrystalScale
    ...
    public CrystalScale() {
        super("CrystalModifier", "Modifies crystal rendering in different ways", Module.Category.VISUAL, true, false, false);
        INSTANCE = this;
    }
