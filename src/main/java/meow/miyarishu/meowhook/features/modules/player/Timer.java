...
class Timer
        extends Module {
    private final meow.miyarishu.meowhook.util.Timer timer = new meow.miyarishu.meowhook.util.Timer( );
    private final meow.miyarishu.meowhook.util.Timer turnOffTimer = new meow.miyarishu.meowhook.util.Timer( );
