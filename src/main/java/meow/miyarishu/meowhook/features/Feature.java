package meow.miyarishu.meowhook.features;
...
import meow.miyarishu.meowhook.manager.TextManager;
...
public class Feature
    ...
    public TextManager renderer = MeowHook.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof MeowHookGui) {
            MeowHookGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
