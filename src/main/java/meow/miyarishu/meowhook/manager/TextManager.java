...
import meow.miyarishu.meowhook.features.gui.font.CustomFont;
...
public class TextManager
    ...
    public void init(boolean startup) {
        FontMod cFont = MeowHook.moduleManager.getModuleByClass(FontMod.class);
        try {
    ...
    public float drawString(String text, float x, float y, int color, boolean shadow) {
        if (MeowHook.moduleManager.isModuleEnabled(FontMod.getInstance().getName())) {
            if (shadow) {
